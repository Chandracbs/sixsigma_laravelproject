              ...
              >
                    ...
                    <div class="flex items-center">
                        ...
                        <span>
                            <?php
                                ...
                                $route = route('contactus.index', ['orderBy' => $orderBy, 'direction' => $direction]);
                            ?>
                            <a href="{{ $route }}">
                ...
                <div class="flex items-center">
                    ...
                    <span>
                        ...
                        <a href="{{ $route }}">
                            <svg class="h-4 w-4 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <?php if ($direction === 'asc' && $orderBy === 'name'): ?>
                                    <polyline points="6 9 12 15 18 9"></polyline>
                                <?php else: ?>
                                    <polyline points="18 15 12 9 6 15"></polyline>
                                <?php endif; ?>
                ...
                <th class="px-4 py-3">
                    <div class="flex items-center">
                        ...
                        <span>
                            ...
                            <a href="{{ $route }}">
                                <svg class="h-4 w-4 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <?php if ($direction === 'asc' && $orderBy === 'created_at'): ?>
                                        <polyline points="6 9 12 15 18 9"></polyline>
                                    <?php else: ?>
                                        <polyline points="18 15 12 9 6 15"></polyline>
                                    <?php endif; ?>
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center space-x-4 text-sm">
                        <a href="{{route('contactus.edit',$value->id)}}">
                            <button
                        ...
                        <form action="{{route('contactus.destroy',$value->id)}}" method="POST" onclick="return confirm('Are you sure you want to delete?');">
                  ...
                  @else
                  <td  style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; text-align:center;" colspan="9">Data Not Found.</td>
                  @endif
