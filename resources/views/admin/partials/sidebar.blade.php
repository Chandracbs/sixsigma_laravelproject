    ...
    <aside
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <li class="relative px-6 py-3">
                ...
                <span class="ml-4">Solutions</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="{{route('whatwedo.index')}}"
                >
            ...
            <li class="relative px-6 py-3">
                ...
                <span class="ml-4">Process We Follow</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <a
                ...
                <span class="ml-4">Technologies We Use</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="{{route('ourclient.index')}}"
                >
                <svg class="h-6 w-6 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="ml-4">Our Clients</span>
                </a>
                </li>
            <li class="relative px-6 py-3">
                <a
            ...
            <li class="relative px-6 py-3">
                ...
                <svg class="h-6 w-6 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="ml-4">Job Openings</span>
                </a>
                </li>
            <li class="relative px-6 py-3">
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="{{route('meetourteam.index')}}"
                >
                <svg class="h-6 w-6 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                  </svg>

                    <span class="ml-4">Meet Our Team</span>
                </a>
                </li>
            <li class="relative px-6 py-3">
                <a
                ...
                <svg class="h-6 w-6 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="ml-4">What Our Client Says</span>
                </a>
                </li>
            <li class="relative px-6 py-3">
                <a
