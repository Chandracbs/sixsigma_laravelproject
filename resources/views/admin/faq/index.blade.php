          ...
          <table class="w-full whitespace-no-wrap">
            <thead>
              ...
              >
                    ...
                    <div class="flex items-center">
                        ...
                        <span>
                            <?php
                                ...
                                $route = route('faq.index', ['orderBy' => $orderBy, 'direction' => $direction]);
                            ?>
                            <a href="{{ $route }}">
                ...
                <th class="px-4 py-3">
                    <div class="flex items-center">
                        <span class="mr-2">Question Asked</span>
                        <span>
                            <?php
                                $orderBy = 'question';
                                $route = route('faq.index', ['orderBy' => $orderBy, 'direction' => $direction]);
                ...
                <th class="px-4 py-3">Answer provided</th>
                <th class="px-4 py-3">
                    <div class="flex items-center">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                    {{Str::limit($value->question,30)}}
                </td>

                <td class="px-4 py-3 text-sm">
                    {!!Str::limit($value->answer,30)!!}
                </td>
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center space-x-4 text-sm">
                        <a href="{{route('faq.edit',$value->id)}}">
                            ...
                            <form action="{{route('faq.destroy',$value->id)}}" method="POST" onclick="return confirm('Are you sure you want to delete?');">
                                @csrf
                                @method('DELETE')
                            <button
                              class="flex items-center justify-between text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
