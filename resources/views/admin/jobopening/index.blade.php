...
<main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
      ...
      <div class="flex justify-between p-4 mb-4">
        ...
        <a href="{{route('jobopening.create')}}">
                    ...
                    <div class="flex items-center">
                        ...
                        <span>
                            <?php
                                ...
                                $route = route('jobopening.index', ['orderBy' => $orderBy, 'direction' => $direction]);
                            ?>
                            <a href="{{ $route }}">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center space-x-4 text-sm">
                        <a href="{{route('jobopening.edit',$value->id)}}">
                            <button
                            ...
                            <form action="{{route('jobopening.destroy',$value->id)}}" method="POST" onclick="return confirm('Are you sure you want to delete?');">
                            @csrf
                            @method('DELETE')
                            <button
                              class="flex items-center justify-between text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
