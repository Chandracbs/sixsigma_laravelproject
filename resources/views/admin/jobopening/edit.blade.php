...
<main class="h-full pb-16 overflow-y-auto">
    <div class="container px-6 mx-auto grid">
      ...
      <form action="{{route('jobopening.update',$jobopening->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div
        ...
        <label class="mt-6 block text-sm">
            ...
            <input
              ...
              name="position_name"
              value="{{$jobopening->position_name}}"
            />
        ...
        <label class="mt-6 block text-sm">
          ...
          <label class="block mt-6 mb-4 text-sm">
            ...
            <textarea
              ...
              name="description"
            >{!!$jobopening->description!!}</textarea>
